...
import login.controller.util.JsfUtil;
import login.controller.util.JsfUtil.PersistAction;
import login.facade.ClienteFacade;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private login.facade.ClienteFacade ejbFacade;
